...
public class WaterRippleView extends View {
    ...
    private static final int WAVE_PAINT_COLOR = 0x90784c35; // 波纹颜色
    private static final float STRETCH_FACTOR_A = 20; // y = Asin(wx+b)+h
    private static final int OFFSET_Y = 0;
    private static final int TRANSLATE_X_SPEED_ONE = 8; // 第一条水波移动速度
    private static final int TRANSLATE_X_SPEED_TWO = 5; // 第二条水波移动速度
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mTotalWidth; i++) {
            ...
            // 绘制第二条水波纹
            canvas.drawLine(i, mTotalHeight - mResetTwoYPositions[i] - 500, i,
                    mTotalHeight, mWavePaint);
        }
